...
CameraBinFastCaptureControl::CameraBinFastCaptureControl(CameraBinSession *session,
							 QObject *parent)
    : QCameraFastCaptureControl(parent)
    , m_session(session)
{

}

CameraBinFastCaptureControl::~CameraBinFastCaptureControl()
{
